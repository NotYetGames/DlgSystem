...
void UDialogueK2Node_SwitchDialogueCallback::CreateSelectionPin()
{
	...
	UEdGraphPin* Pin = CreatePin(EGPD_Input, K2Schema->PC_Name, TEXT(""), nullptr, false, false, GetSelectionPinName());
	FDialogueBlueprintUtilities::SetPinAutogeneratedDefaultValueBasedOnType(Pin);
}
...
FString UDialogueK2Node_SwitchDialogueCallback::GetPinNameGivenIndex(int32 Index)
{
	return Index < DialoguePinNames.Num() ? DialoguePinNames[Index].ToString() : "";
}

FString UDialogueK2Node_SwitchDialogueCallback::GetUniquePinName()
{
	checkNoEntry();
	return "";
}
...
void UDialogueK2Node_SwitchDialogueCallback::CreateCasePins()
{
	...
	{
		CreatePin(EGPD_Output, K2Schema->PC_Exec, TEXT(""), nullptr, false, false, PinName.ToString());
	}
}
...
void UDialogueK2Node_SwitchDialogueCallback::CreateFunctionPin()
{
	...
	const UEdGraphSchema_K2* K2Schema = GetDefault<UEdGraphSchema_K2>();
	UEdGraphPin* FunctionPin = CreatePin(EGPD_Input, K2Schema->PC_Object, FString(), FunctionClass, false, false, FunctionName.ToString());
